...
$(function(){//儲存目前作答到第幾題
    ...
    $("#startButton").on("click",function(){
        if(currentQuiz==null){
            ...
            if(first==0)
            {
                $("body").append('<input id="returnButton" type="Button" value="回復上一動">');
            ...
            $.each($(":radio"),function(i,val){
                if(val.checked){
                    ...
                    if(isNaN(questions[currentQuiz].answers[i][1]))
                    {
                        $("returnButton").empty();
                        //通往最終結果
                        var finalResult=questions[currentQuiz].answers[i][1];//顯示最終結果的標題
                        ...
                        currentQuiz=questions[currentQuiz].answers[i][1]-1;//顯示新的題目
